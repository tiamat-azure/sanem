...
| Volume               | `video.volume` + coupure du son, persisté en `localStorage`. Flèches haut/bas : ±0,05. <kbd>Contrôle</kbd>+<kbd>flèche en bas</kbd> coupe le son, <kbd>Contrôle</kbd>+<kbd>flèche haut</kbd> le réactive. Si le volume est à 0 au moment de réactiver, restaurer le dernier niveau non nul (sinon un pas de 0,05) : lever `muted` seul ne suffit pas. Tooltips `.has-tip` + `aria-label` (sans `title` natif) : mute « Couper le son (raccourci : Contrôle + flèche en bas) » / « Réactiver le son (raccourci : Contrôle + flèche haut) » ; un seul tooltip sur le wrap volume « Volume (raccourci : flèche haut / flèche en bas) », le curseur restant nommé « Volume ». |
