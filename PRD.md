...
| Épisode précédent / suivant | Icônes skip-back / skip-forward, sans texte visible. <kbd>Page précédente</kbd> / <kbd>Page suivante</kbd> empruntent le même chemin que les boutons, no-op s'il n'y a pas de voisin — y compris lorsque le curseur volume a le focus (`preventDefault`, pas de paging natif du `range`). Tooltips « Épisode précédent (raccourci : Page précédente) » / « Épisode suivant (raccourci : Page suivante) ». Le précédent est masqué sur le premier épisode et hors série. Chip bas-droit en fin d'épisode : mêmes icônes, précédent à gauche du suivant. |
